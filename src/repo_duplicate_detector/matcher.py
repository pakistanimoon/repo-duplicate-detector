...
from .exceptions import InvalidRepositoryError, GitHubAPIError
from .utils import parse_repo_url, chunk_list, safe_get
...
class RepoMatcher:
    ...
    def _get_repo_data(self, owner: str, repo: str) -> Dict:
        ...
        try:
            ...
            repo_data["contributors"] = self.fetcher.get_repository_contributors(owner, repo, per_page=20)
            repo_data["activity"] = {
            ...
            "clusters": [
                {
                    ...
                    "top_repo": max(cluster, key=lambda r: r.get("stargazers_count", 0))["full_name"],
                }
